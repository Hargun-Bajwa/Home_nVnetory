...
CREATE TABLE IF NOT EXISTS `homeinventorydb`.`users` (
  ...
  `ResetUUID` VARCHAR(50) NULL,
  `RegisterUUID` VARCHAR(50) NULL,
...
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('admin','password','hargun.bajwa.workmail+admin@gmail.com','Admin','Admin',1,1);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('admin2','password','hargun.bajwa.workmail+admin2@gmail.com','Admin2','Admin2',0,1);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('anne','password','hargun.bajwa.workmail+anne@gmail.com','Anne','Annerson',1,0);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('barb','password','hargun.bajwa.workmail+barb@gmail.com','Barb','Barber',1,0);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('carl','password','hargun.bajwa.workmail+carl@gmail.com','Carl','Carlson',1,0);
INSERT INTO `users` (`Username`,`Password`,`Email`,`FirstName`,`LastName`,`Active`,`IsAdmin`) VALUES ('don','password','hargun.bajwa.workmail+don@gmail.com','Don','Donatello',1,0);
...
INSERT INTO `items` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (9,'organizer',200,'barb');
INSERT INTO `items` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (3,'speakers',80,'barb');
INSERT INTO `items` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (2,'Towel bar',19,'don');
